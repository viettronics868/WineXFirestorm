...
import com.namdungphuong.winxfirestorm.newGenerateButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       /* RunningThreads p1 = new RunningThreads();
        ...
        {	
        	...
        	Typeface myTypeface = Typeface.createFromAsset(this.getAssets(),"font/batmfa.ttf");
        ...
        timerText.setText("");
  		Typeface myTypeface = Typeface.createFromAsset(this.getAssets(),"font/Futured.TTF");
