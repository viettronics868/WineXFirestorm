...
public class VideoWallDemoActivity extends Activity implements
  ...
  //private static final double THUMBNAIL_ASPECT_RATIO = 4 / 3d;
...
//***********************************
    ...
    //thumbnailViewToLoaderMap.put(thumbnailView, thumbnailLoader);
    //thumbnailView.setImageResource(R.drawable.loading_thumbnail);      //from youtube
    //String videoId = (String) thumbnailView.getTag();            //from youtube
  ...
  private void maybeStartDemo() {
    ...
    //setProgressBarIndeterminateVisibility(true);
    //Log.d(LOG_TAG,"set progress bar");
/*
    thumbnailViewToLoaderMap.put(thumbnailView, thumbnailLoader);
    thumbnailView.setImageResource(R.drawable.loading_thumbnail);      //from youtube
    String videoId = (String) thumbnailView.getTag();            //from youtube
...
*/  //hidePDialog();
  ...
  private void loadNextThumbnail() {
    ...
    //hidePDialog();
    //Log.d(LOG_TAG,"hide Progress dialog");
